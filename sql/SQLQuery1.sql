...
use master 
go
alter database QL_NHATHUOCTY set single_user with rollback immediate
...
RETURNS TABLE
AS 
      RETURN SELECT TOP 10 THUOC.MATHUOC, THUOC.TENTHUOC, THUOC.MANHOM, THUOC.CONGDUNG, SUM(X.SOLUONG) AS SOLUONG FROM XUATTHUOC X JOIN THUOC
      ON X.THUOC = THUOC.MATHUOC
      JOIN DONHANGXUAT D
      ON YEAR(D.NGAYLAP) = @nam
      GROUP BY THUOC.MATHUOC, THUOC.TENTHUOC, THUOC.MANHOM, THUOC.CONGDUNG
...
RETURNS TABLE
AS 
      RETURN SELECT top 10 THUOC.MATHUOC, THUOC.TENTHUOC, THUOC.MANHOM, SUM(X.SOLUONG) AS SOLUONG FROM XUATTHUOC X JOIN THUOC
      ON X.THUOC = THUOC.MATHUOC
      JOIN DONHANGXUAT D
      ON YEAR(D.NGAYLAP) = @nam
...
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN001', 'HCM-X4-25', 30, '10/12/2022', '29/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN001', 'HCM-X4-79', 30, '10/12/2022', '29/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN002', 'HCM-X2-16', 40, '01/12/2022', '01/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN002', 'HCM-X2-164', 30, '03/02/2022', '03/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN002', 'HCM-X2-198', 50, '12/01/2022', '12/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN003', 'BN.TS2-15', 25,'13/01/2022', '1312/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN003', 'BN.TS2-51', 40, '20/12/2022', '20/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN003', 'ETT-163', 30, '12/12/2022', '12/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN003', 'ETT-165', 40, '12/12/2022', '12/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN003', 'ETT-50', 30, '12/12/2022', '12/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN003', 'ETT-94', 40, '12/12/2022', '12/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN003', 'GDA-10', 20, '12/12/2022', '12/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN004', 'CME-3', 20, '30/11/2022', '30/11/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN004', 'LBF-1', 30, '30/11/2022', '30/11/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN004', 'SAK-118', 50, '28/11/2022', '28/11/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN004', 'SAK-169', 20, '28/11/2022', '28/11/2023')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN004', 'SAK-185', 40, '28/11/2022', '28/11/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN004', 'SAK-37', 60, '28/11/2022', '28/11/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN005', 'BD.TS5-19', 30, '23/12/2022', '23/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN005', 'BD.TS5-4', 20, '23/12/2022', '23/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN005', 'BD.TS5-5', 20, '20/12/2022', '20/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN006', 'UV-2', 30, '10/01/2023', '10/11/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN006', 'UV-65', 50, '10/01/2023', '10/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN007', 'HCM-X4-25', 20, '02/12/2022', '02/12/2025')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN007', 'HCM-X4-79', 40, '02/12/2022', '08/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN008', 'HCM-X2-16', 30, '07/12/2022', '07/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN008', 'HCM-X2-164', 10, '24/12/2022', '24/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN009', 'ETT-163', 20, '19/06/2022', '19/06/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN009', 'ETT-165', 20, '19/06/2022', '19/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN009', 'BN.TS2-15', 20, '15/12/2022', '15/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN009', 'BN.TS2-51', 20, '17/12/2022', '17/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN010', 'SAK-118', 30, '02/12/2022', '02/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN010', 'SAK-185', 10, '02/12/2022', '02/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN011', 'BD.TS5-19', 30, '11/11/2022', '11/11/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN011', 'BD.TS5-5', 10, '11/11/2022', '11/11/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN012', 'UV-65', 10, '07/12/2022', '07/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN012', 'UV-2', 10, '07/12/2022', '07/12/2023')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN013', 'HCM-X4-25', 30, '07/12/2022', '07/12/2023')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN013', 'HCM-X4-79', 10, '02/12/2022', '02/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN014', 'HCM-X2-16', 30, '02/12/2022', '02/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN014', 'HCM-X2-198', 10, '02/12/2022', '02/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN015', 'ETT-50', 10, '07/12/2022', '07/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN015', 'BN.TS2-51', 10, '07/12/2022', '07/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN016', 'HCM-X2-164', 30, '07/12/2022', '07/12/2024')
INSERT INTO NHAPTHUOC(MADONHANG, THUOC, SOLUONG, NGAYSX, NGAYHETHAN)
      VALUES ('DN016', 'HCM-X2-198', 10, '07/12/2022', '05/12/2024')
